...
#define BUFFERCELL_COLOR_RED            2
#define BUFFERCELL_COLOR_GREEN          3
#define BUFFERCELL_COLOR_YELLOW         4
#define BUFFERCELL_COLOR_BLUE           5
#define BUFFERCELL_COLOR_MAGENTA        6
#define BUFFERCELL_COLOR_CYAN           7
#define BUFFERCELL_COLOR_WHITE          8
...
#define BUFFERCELL_COLOR_BRIGHT_BLACK   16
...
static inline void setBufferCellInvertColor(Buffer* buffer, int x, int y)
{
    buffer->bufferArea[y][x].isInvertColor = true;
}
